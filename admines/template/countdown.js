...
;(function($) {
	...
	var htmlParser = function(timerObject, options, format) {
		...
		var counter_days    = '<div class="days"><span class="count" style="font-size: 18px;">' + timerObject.days + ' jour </span></div>';
		var counter_hours   = '<div class="hours"><span class="count" style="font-size: 18px;">' + timerObject.hours + ' heures </span></div>';
		var counter_minutes = '<div class="minutes"><span class="count" style="font-size: 18px;">' + timerObject.minutes + '  mn</span></div>';
		var counter_seconds = '<div class="seconds" style="display:none;"><span class="count" >' + timerObject.seconds + ' </span><span class="title">Seconde</span></div>';
