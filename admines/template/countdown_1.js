...
;(function($) {
	...
	var htmlParser = function(timerObject, options, format) {
		...
		var counter_days    = '<div class="days"><span class="count">' + timerObject.days + '</span><span class="title">jour</span></div>';
		var counter_hours   = '<div class="hours"><span class="count">' + timerObject.hours + '</span><span class="title">heures</span></div>';
		var counter_minutes = '<div class="minutes"><span class="count">' + timerObject.minutes + '</span><span class="title">mn</span></div>';
		var counter_seconds = '<div class="seconds" style="display:none;"><span class="count" >' + timerObject.seconds + '</span><span class="title">Secondes</span></div>';
