		...
		init: function() {
			if ($("#wizard_101").length) {
				...
				$("#wizard_101").steps({
					...
					labels: {
						next: "Suivant <i class=\"fa fa-angle-right\"></i>",
						previous: "<i class=\"fa fa-angle-left\"></i> Précedent",
						current: "",
						finish: "Agree"
					},
			...
			if ($("#wizard_form").length) {
				...
				wizard_form.steps({
					...
					labels: {
						next: "Étape suivante <i class=\"fa fa-angle-right\"></i>",
						previous: "<i class=\"fa fa-angle-left\"></i> Étape précedente",
						current: "",
						finish: "<i class=\"fa fa-check\"></i> Enregistrer"
					},
