...
Class M_categories_couffin extends CI_Model {
	
public $table='av_categories_couffin';

public $field_id='categorie_couffin_id';
public $categorie_name='categorie_couffin_name';
		...
		function get_categories_couffin() {
