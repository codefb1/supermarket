...
Class M_attributs_values extends CI_Model {
	
public $table='av_attributs_values';
public $field_id='attribut_value_id';
...
public $attribut_id='attribut_id';
		...
		function update_this($param_1,$update_entry){
			...
			try {
				$this->db->select('*');		
				$this->db->from($this->table);
				$this->db->join($this->table_attributs, $this->table.".".$this->attribut_id." = ".$this->table_attributs.".".$this->attribut_id,'left');
