        ...
        <form data-parsley-validate="" novalidate=""id="submitpage"  method="POST" action="<?=base_url().'banners/edit';?>">
			  ...
			  <option value="">Selectionner</option>
			     ...
			     <?php foreach($products as $product) :?>
										<option <?php  if($banners->product_id==$product->product_id){ echo"selected";} ?> value="<?php echo $product->product_id;?>"> <?php echo $product->product_name;?></option>
										 <?php endforeach; ?>
									</select>  </div>
            ...
            <div class="row">
              ...
              <select id="bannier_position" name="bannier_position" class="form-control  btn-xs">
				  <option value="">Selectionner</option>
				<option value="2" <?php  if($banners->bannier_position==2){ echo"selected";} ?>> Slider</option>
				<option value="1" <?php  if($banners->bannier_position==1){ echo"selected";} ?> > Bannier header</option>
				<option value="3" <?php  if($banners->bannier_position==3){ echo"selected";} ?>> Page home  block Mouton entier</option>
				<option value="4" <?php  if($banners->bannier_position==4){ echo"selected";} ?>> Page Mouton entier</option>
				<option value="5" <?php  if($banners->bannier_position==5){ echo"selected";} ?>> Page La Boucherie</option>
				<option value="6" <?php  if($banners->bannier_position==6){ echo"selected";} ?>> Page Panier</option>
				<option value="7" <?php  if($banners->bannier_position==7){ echo"selected";} ?>> Promotions</option>
				<option value="8" <?php  if($banners->bannier_position==8){ echo"selected";} ?>> Goffa</option>
          ...
          <div class="form-group">
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="description" class="form-control" type="text" data-parsley-required="true" data-parsley-type="alphanum" name="banner_text_deux" value="<?php echo $banners->banner_text_deux;?>">
              </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="description" class="form-control" type="text" data-parsley-required="true" data-parsley-type="alphanum" name="banner_text_troix" value="<?php echo $banners->banner_text_troix;?>">
              </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="banner_botton_text" class="form-control" type="text" data-parsley-required="true" data-parsley-type="alphanum" name="banner_botton_text" value="<?php echo $banners->banner_botton_text;?>">
              </div>
