  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form data-parsley-validate="" novalidate=""id="submitpage"  method="POST" action="<?=base_url().'optionsTypes/add';?>">
		...
		<?php if(@$process_status == 1) { ?>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="name" class="form-control" type="text"  name="option_type_name" value="<?php echo $option_type_name;?>">
              </div>
