  ...
  <button class="btn btn-shadow btn-primary" type="button"onClick="location.href='<?php echo base_url().'orders/associations';?>'"><i class=" fa fa-reply"></i>  Listes des commandes</button>
...
<div class="col-sm-6">
  ...
  <?php 
		...
		if($orders->order_payment_status==3){$label='label-warning';$order_payment_status='Commande en préparation';}
	...
	<div class="row m-b">
	 <div class="col-md-4 commande">
              ...
              <div class="widget portlet">
				...
				<div class="row ">
				  <div class="form-group">
							<label  class="col-md-4 control-label">Créer le</label>
							<div class="col-md-8">
				...
				<div class="row">
						<div class="form-group">
							<label  class="col-md-4 control-label">Montant total TTC</label>
							<div class="col-md-8">
								<input type="text" class="form-control " disabled name="" value="<?php echo (number_format($orders->order_total_amount_association, 2, ',', ''))."  €" ?>" />
	 ...
	 <div class="col-lg-12"><h4 class="widget-title"><b>Panier</b></h4></div>
		<div class="col-lg-12">
			 ...
			 <?php $totalPoids=0;  $totalPriceHT=0; $totalPriceTTC=0; $i=1; foreach($orders_detail as $order_detail) : 
                                if($order_detail->order_product_entier_association){ 
			...
			?>
						   <tr class="supp-<?php echo $order_detail->order_detail_id;?>">
							...
							<td class="sub_col"><?php echo $product->categorie_name;?> </td>
							<td class="sub_col"><?php echo $order_detail->product_quantity;?> </td>
							<td class="sub_col"><?php echo $product->product_name;  echo $assocation_country;?> </td>
							...
							<td class="sub_col"><?php echo (number_format($order_detail->orders_detail_product_price * $order_detail->product_quantity, 2, ',', ''))."  euro" ;?> </td>
						...
						<tr class="supp-">
							...
							<td class="sub_col"><?php echo (number_format($totalPriceHT, 2, ',', ''))."  euro" ;?> </td>
							<td class="sub_col"><?php echo $taxe_value;?> % </td>
							<td class="sub_col"><?php echo (number_format($totalPriceTTC, 2, ',', ''))."  euro" ;?> </td>
	  ...
	  <div class="col-md-12 infDelivery">
              ...
              <div class="widget portlet">
				...
				<div class="row ">
				  <div class="form-group">
							<label  class="col-md-2 control-label">De :  <?php  echo $orders->partener_city; ?> vers : <?php  echo $orders->order_shipping_city;?> </label>
							<div class="col-md-2">
				...
				<div class="row">
						<div class="form-group">
							<label  class="col-md-2 control-label">Prix de livraison </label>
							<div class="col-md-2">
								 <input type="text" class="form-control " disabled name="" value="<?php echo "0 euro" ;?>" />
...
<div class="row"> 
	  <div class="col-md-12 payment">
              ...
              <div class="widget portlet">
				...
				<div class="row ">
				  <div class="form-group">
							<label  class="col-md-2 control-label" style="top: 3px!important;">Staut de paiement</label>
							<div class="col-md-3">
								 <span  class="span-<?php  echo $orders->order_id;?> label <?php echo $label ?> " >  <?php echo $order_payment_status;?></span>  par   <?php echo $mode ?>  
							</div>
						</div>
...
<div class="row"> 
	  <div class="col-md-12 fournisseur">
              ...
              <div class="widget portlet">
				...
				<div class="row ">
				  <div class="form-group">
							<label  class="col-md-2 control-label" style="top: 3px!important;">Fournisseur</label>
							<div class="col-md-3">
				...
				<div class="row">
						<div class="form-group">
							<label  class="col-md-2 control-label"  style="top: 3px!important;" >Ville Fournisseur  </label>
							<div class="col-md-3">
				...
				<div class="row">
						<div class="form-group">
							<label  class="col-md-2 control-label">Statut Fournisseur</label>
							<div class="col-md-3">
	  ...
	  <div class="col-md-12 delivery">
              ...
              <div class="widget portlet">
				...
				<div class="row">
						<div class="form-group">
							<label  class="col-md-3 control-label">Tarif de livraison </label>
							<div class="col-md-3">
				...
				<div class="row">
						<div class="form-group">
							<label  class="col-md-3 control-label">Référence chez  Livreur</label>
							<div class="col-md-3">
  ...
  <textarea name="order_comments_parteners" id="order_comments_parteners"><?php echo $orders->order_comments_parteners;?></textarea></div>
	  ...
	  <div class="col-md-6 payment">
			...
			<div class="row ">
				  <div class="form-group">
							...
							<div class="col-md-3">
							<?php echo (number_format($orders->order_products_prices, 2, ',', ''))."  euro" ?>
							</div>
						</div>
				...
				<div class="row ">
				  <div class="form-group">
							...
							<div class="col-md-3">
							<?php echo (number_format($orders->order_total_marge, 2, ',', ''))."  euro" ?>
							</div>
						</div>
				...
				<div class="row ">
				  <div class="form-group">
							<label  class="col-md-4 control-label" style="top: 3px!important;">Prix d'achat de livraison </label>
							<div class="col-md-3">
							<?php echo (number_format($orders->order_shipping_rate, 2, ',', ''))."  euro" ?>
							</div>
						</div>
				...
				<div class="row ">
				  <div class="form-group">
							<label  class="col-md-4 control-label" style="top: 3px!important;">Prix de vente livraison </label>
							<div class="col-md-3">
							<?php echo (number_format($orders->order_shipping_rate, 2, ',', ''))."  euro" ?>
							</div>
						</div>
				...
				<div class="row ">
				  <div class="form-group">
							<label  class="col-md-4 control-label" style="top: 3px!important;">Ecart </label>
							<div class="col-md-3">
							<?php echo (number_format($orders->order_shipping_rate-$orders->order_shipping_rate, 2, ',', ''))."  euro" ?>
							</div>
						</div>
    ...
    font-weight: bold;
    color: red;'>
							<?php echo (number_format($orders->order_total_marge, 2, ',', ''))."  euro" ?> TCC
							</div>
						</div>
