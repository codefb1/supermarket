...
<div class="col-sm-12">
  <h2 class="page_title" style="text-align: center;">Client:  <?php echo $customer->customer_firstname;?>   <?php echo $customer->customer_lastname;?></h2>
 <h3 class="page_title" style="text-align: center;">Adress:   <?php echo $customer->customer_address.' '. $customer->customer_zip.' '. $customer->customer_city;?></h3>
            ...
            <table class="table info_table table-hover" id="accounts_table">
              ...
              <?php foreach($orders_list as $orders) :
			   ...
			   <?php if($orders->is_association){ ?> <i style="color: #64b92a;" class="  glyphicon glyphicon-star"></i> <?php } ?>
					...
					<td class="sub_col" ><span  class="span-<?php  echo $orders->order_id;?> label label-<?php echo $label;?> icone_action" style="background-color: <?php echo $orders->status_color;?>; border-color: <?php echo $orders->status_color;?>;" ><?php echo $orders->status_name;?></span></td>							
