      ...
      <div class="col-lg-3 col-md-6">
        <div class="panel panel-default">
          <div class="stat_box stat_up">
            ...
            <div class="stat_content"> <span class="stat_count">321</span> <span class="stat_name">Comments</span> </div>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6">
        <div class="panel panel-default">
          <div class="stat_box stat_up">
            ...
            <div class="stat_content"> <span class="stat_count">$81 483.00</span> <span class="stat_name">Sale (last month)</span> </div>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6">
        <div class="panel panel-default">
          <div class="stat_box stat_down">
            ...
            <div class="stat_content"> <span class="stat_count">637</span> <span class="stat_name">Tasks</span> </div>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6">
        <div class="panel panel-default">
          <div class="stat_box stat_up">
            ...
            <div class="stat_content"> <span class="stat_count">2483</span> <span class="stat_name">Messages</span> </div>
          </div>
        </div>
      </div>
    </div>
...
<div class="row">
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-body">
        <div id="nvd3_cumulativeLine" style="width:100%;height:300px"> <svg></svg> </div>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="panel panel-default">
      <div class="panel-body">
        ...
        <div id="latest-images" class="owl-carousel owl-theme">
          <div class="item"><img class="img-thumbnail" src="<?php echo base_url().'template/';?>assets/img/gallery/Image001_tn.jpg" alt=""></div>
          <div class="item"><img class="img-thumbnail" src="<?php echo base_url().'template/';?>assets/img/gallery/Image002_tn.jpg" alt=""></div>
          <div class="item"><img class="img-thumbnail" src="<?php echo base_url().'template/';?>assets/img/gallery/Image003_tn.jpg" alt=""></div>
          <div class="item"><img class="img-thumbnail" src="<?php echo base_url().'template/';?>assets/img/gallery/Image004_tn.jpg" alt=""></div>
          <div class="item"><img class="img-thumbnail" src="<?php echo base_url().'template/';?>assets/img/gallery/Image005_tn.jpg" alt=""></div>
          <div class="item"><img class="img-thumbnail" src="<?php echo base_url().'template/';?>assets/img/gallery/Image006_tn.jpg" alt=""></div>
          <div class="item"><img class="img-thumbnail" src="<?php echo base_url().'template/';?>assets/img/gallery/Image007_tn.jpg" alt=""></div>
          <div class="item"><img class="img-thumbnail" src="<?php echo base_url().'template/';?>assets/img/gallery/Image008_tn.jpg" alt=""></div>
          <div class="item"><img class="img-thumbnail" src="<?php echo base_url().'template/';?>assets/img/gallery/Image009_tn.jpg" alt=""></div>
          <div class="item"><img class="img-thumbnail" src="<?php echo base_url().'template/';?>assets/img/gallery/Image010_tn.jpg" alt=""></div>
        </div>
      </div>
    </div>
  </div>
