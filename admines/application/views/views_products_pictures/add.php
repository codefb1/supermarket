  ...
  <button class="btn btn-shadow btn-primary" type="button"onClick="location.href='<?php echo base_url().'productspictures/listpictures/'.$product_id;?>'"><i class=" fa fa-reply"></i>  Listes des photos</button>
...
<div class="row">
  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      <div class="panel-heading">Nouvelle photo</div>
      <div class="panel-body">
        <form data-parsley-validate="" novalidate=""id="submitpage"  method="POST" action="<?=base_url().'productspictures/add';?>">
		
			<?php if(@$this->uri->segment(3) == 1) { ?>
						<div class="alert alert-success"><i class="zmdi zmdi-check"></i> Opération réussie</div>
					<?php } ?>
					<?php if(@$this->uri->segment(3) == 2) { ?>
					<div class="alert alert-danger"><i class="zmdi zmdi-close-circle zmdi-hc-fw"></i> Opération échouée !</div><?php } ?>
            ...
            <div class="row">
			  ...
			  <option value=""> Selectionnez...</option>
				<option value="1" <?php  if($picture_view==1){ echo"selected";} ?> > Client</option>
				<option value="2" <?php  if($picture_view==2){ echo"selected";} ?>> Boucherie</option>
					</select>  
 ...
 <div class="form-group">			 
                    ...
                    <div class="col-sm-12">  
					<input type="text" name="product_pictures_alt"  class="form-control"   value="<?php echo $product_pictures_alt;?>"/>
                    </div>  </div>
        </div>
		 <div class="form-group" >
            <div class="row">
			  ...
			  <option value=""> Selectionnez...</option>
				<option value="1" <?php  if($product_picture_emplacement==1){ echo"selected";} ?> > Panier ou block</option>
				<option value="2" <?php  if($product_picture_emplacement==2){ echo"selected";} ?>>  List produits</option>
					<option value="3" <?php  if($product_picture_emplacement==3){ echo"selected";} ?>>  Page produit</option>
			   ...
			   <div class="col-sm-12">
					<div class="dz-preview dz-processing dz-error dz-image-preview example-preview animated fadeInRight"  >
						<div class="dz-details">
							<img data-dz-thumbnail="" alt="avatar" id="block-image-banners" src="<?php echo base_url().'medias/products/'.$product_pictures; ?>" class="img-responsive">
						</div>
          ...
          <input type="hidden" id="product_pictures" name="product_pictures" value="" />
