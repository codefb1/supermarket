  ...
  <button class="btn btn-shadow btn-primary" type="button"onClick="location.href='<?php echo base_url().'attributsValues';?>'"><i class=" fa fa-reply"></i>  Liste des  valeurs</button>
  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form data-parsley-validate="" novalidate=""id="submitpage"  method="POST" action="<?=base_url().'attributsValues/add';?>">
		...
		<?php if(@$process_status == 1) { ?>
			  ...
			  <option value="">Selectionner</option>
			    ...
			    <?php foreach($attributs as $attribut) :?>
										<option <?php  if($attribut->attribut_id==$attributt_id){ echo"selected";} ?> value="<?php echo $attribut->attribut_id;?>"> <?php echo $attribut->attribut_name;?></option>
										 <?php endforeach; ?>
									</select> </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="name" class="form-control" type="text"  name="attribut_value" value="<?php echo $attribut_value;?>">
              </div>
