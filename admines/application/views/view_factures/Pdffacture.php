  ...
  <table style="width:450px;"  >
   ...
   <table >
    ...
    <table  >
	 ...
	 <tr >
           <td></td>
        	 <td  style="text-align: right;font-size: 11px;"> Total HT: </td>
			 		         <td  width="50"></td>
			 <td  style="text-align: right;font-size: 11px;"><?="".(number_format($htCart+$htShopping, 2, '.', ''));?> &euro; </td>
		</tr>
		<tr>
           <td></td>
		 ...
		 <tr >
           <td></td>
        	 <td  style="text-align: right;font-size: 11px;"> Total TTC: </td>
			 		         <td  width="50"></td>
			 <td  style="text-align: right;font-size: 11px;"><?="".(number_format($total, 2, '.', ''));?> &euro; </td>
		</tr>
   </table>
