  ...
  <button class="btn btn-shadow btn-primary" type="button"onClick="location.href='<?php echo base_url().'certificats';?>'"><i class=" fa fa-reply"></i>  Liste des  bannières</button>
...
<div class="row">
  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      <div class="panel-heading">Edit certificat</div>
      <div class="panel-body">
        <form data-parsley-validate="" novalidate=""id="submitpage"  method="POST" action="<?=base_url().'certificats/edit';?>">
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="certificat_name" class="form-control" type="text" data-parsley-required="true" data-parsley-type="alphanum" name="certificat_name" value="<?php echo $certificat->certificat_name;?>">
              </div>
            ...
            <div class="row">
             ...
             <textarea name="certificat_discription"><?php echo $certificat->certificat_discription;?></textarea>
              </div>
			   ...
			   <div class="col-sm-12">
				  ...
				  <div id="progressbar" class="uk-progress uk-hidden">
					<div class="uk-progress-bar" style="width: 0%;">...</div>
              		  ...
              		  <div class="form-group" id="block-certificats" >
					  <div class="row">
			   <div class="col-sm-12">
					<div class="dz-preview dz-processing dz-error dz-image-preview example-preview animated fadeInRight"  >
						<div class="dz-details">
							<img data-dz-thumbnail=""   alt="avatar" id="block-image-certificats" src="<?php echo base_url().'medias/certificats/'.$certificat->certificat_picture;?>" class="img-responsive">
						</div>
            ...
            <input type="hidden" class="form-control" name="certificat_id" id="certificat_id" value="<?=$certificat->certificat_id;?>">
							  	<input type="hidden" id="certificat_picture" name="certificat_picture" value="<?=$certificat->certificat_picture;?>" />
                            	   </br> </br>
        </form>
		<div class="form-sep">
