  ...
  <button class="btn btn-shadow btn-primary" type="button"onClick="location.href='<?php echo base_url().'categories';?>'"><i class="icon-refresh"></i> Recharger</button>
              		
   <button class="btn btn-shadow btn-primary" type="button"onClick="location.href='<?php echo base_url().'categories/add/';?>'"><i class="icon-plus"></i> Nouvelle catégorie</button>
  ...
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading"> Catégories </header>
		  ...
		  <?php foreach ($categories_list as $categorie): 
               ...
               <tr class="supp-<?php  echo $categorie->categorie_id;?>"> 
					   ...
					   <td class="sub_col" > <span style="position: relative;top:5px;"> <?php echo $categorie->categorie_name;?> </span> </td>
							...
							<a href="<?php echo base_url().'categories/edit/0/'.$categorie->categorie_id;?>"><button type="button" class="btn btn-outline btn-success"><i class="glyphicon glyphicon-pencil"></i></button></a>
