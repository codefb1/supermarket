...
<div class="row">
  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      <div class="panel-heading">Editer partenaire</div>
      <div class="panel-body">
        <form data-parsley-validate="" novalidate=""id="submitpage"  method="POST" action="<?=base_url().'partners/edit';?>">
...
<?php if(@$this->uri->segment(3) == 1) { ?>
			  ...
			  <option value="">Selectionner</option>
										...
										<option <?php  if($partener->partener_type==1){ echo"selected";} ?> value="1"> Boucherie</option>
										 <option <?php  if($partener->partener_type==2){ echo"selected";} ?> value="2"> Autre</option>
									</select> </div>
			 ...
			 <div class="form-group is_type "  <?php  if($partener->partener_type!= 1){  ?>  style="display:none;"  <?php  } ?>>
			  ...
			  <option value="">Selectionner</option>
										...
										<option <?php  if($partener->certificat_id==$certificats->certificat_id){ echo"selected";} ?> value="<?php echo $certificats->certificat_id;?>"> <?php echo $certificats->certificat_name;?></option>
								 <?php endforeach; ?>
									</select> </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="partener_lastname" class="form-control" type="text" data-parsley-required="true" data-parsley-type="alphanum" name="partener_lastname" value="<?php echo $partener->partener_lastname;?>">
              </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="partener_repensable" class="form-control" type="text" data-parsley-required="true" data-parsley-type="alphanum" name="partener_repensable" value="<?php echo $partener->partener_repensable;?>">
              </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="partener_siret" class="form-control" type="text" data-parsley-required="true" data-parsley-type="alphanum" name="partener_siret" value="<?php echo $partener->partener_siret;?>">
              </div>
		  ...
		  <div class="form-group" >
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="partener_email" class="form-control" type="text" data-parsley-required="true" data-parsley-type="alphanum" name="partener_email" value="<?php echo $partener->partener_email;?>">
              </div>
			...
			<div class="form-group" <?php  if($partener->partener_type!= 1){  ?>  style="display:none;"  <?php  } ?> >
            <div class="row">
              <div class="col-lg-12">
                <label  for="F1">Mot de passe   </label>
                <input id="partener_password" class="form-control" type="text" data-parsley-required="true" data-parsley-type="alphanum" name="partener_password" value="<?php echo $partener->partener_password;?>">
              </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="partener_adress" class="form-control" type="text" data-parsley-required="true" data-parsley-type="alphanum" name="partener_adress" value="<?php echo $partener->partener_adress;?>">
              </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="partener_zip" class="form-control" type="text" data-parsley-required="true" data-parsley-type="alphanum" name="partener_zip" value="<?php echo $partener->partener_zip;?>">
              </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="partener_city" class="form-control" type="text" data-parsley-required="true" data-parsley-type="alphanum" name="partener_city" value="<?php echo $partener->partener_city;?>">
              </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="partener_phone" class="form-control" type="text" data-parsley-required="true" data-parsley-type="alphanum" name="partener_phone" value="<?php echo $partener->partener_phone;?>">
              </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="partener_phone_portable" class="form-control" type="text" data-parsley-required="true" data-parsley-type="alphanum" name="partener_phone_portable" value="<?php echo $partener->partener_phone_portable;?>">
              </div>
			  ...
			  <div class="col-lg-12">
                <label  for="F1">Code postal  </label>
				       <select
                    multiple="multiple"
                    name="departement_codes[]"
                    id="code_zip_select"
                >
                    <?php foreach($code_zip_list as $code_zip) : ?>
					     <option    value="<?php echo $code_zip->departement_code?>" <?php foreach($code_zip_partener_list as $code_zip_partener) : ?>   <?php  if($code_zip_partener->departement_code=== $code_zip->departement_code){  ?>  selected  <?php  } ?> <?php endforeach; ?>><?php echo $code_zip->departement_code;?></option>
                 <?php endforeach; ?>
                </select>
					</div>
					</div>
        	 ...
        	 <div class="form-group">
			   ...
			   <div class="row">
					<div class="dz-preview dz-processing dz-error dz-image-preview example-preview animated fadeInRight"  >
						...
						<img data-dz-thumbnail="" style="width: 20%;" alt="avatar" id="block-image-partner" src="<?php echo base_url().'medias/parteners/'. $partener->partener_certif;; ?>" class="img-responsive">
			...
			<input type="hidden" id="partener_certif" name="partener_certif" value="<?=$partener->partener_certif;?>" />
			    
		
		 <input type="hidden" class="form-control" name="partener_id" id="partener_id" value="<?=$partener->partener_id;?>">
