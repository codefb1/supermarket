...
<div class="row">
  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      <div class="panel-heading">Nouvel  option</div>
      <div class="panel-body">
        <form data-parsley-validate="" novalidate=""id="submitpage"  method="POST" action="<?=base_url().'categoriesOptions/add';?>">
		...
		<?php if(@$process_status == 1) { ?>
			  ...
			  <option value="">Selectionner</option>
			    ...
			    <?php foreach($categories as $categorie) :?>
										<option <?php  if($categorie->categorie_id==$categorie_id){ echo"selected";} ?> value="<?php echo $categorie->categorie_id;?>"> <?php echo $categorie->categorie_name;?></option>
										 <?php endforeach; ?>
									</select> </div>
			  ...
			  <option value=""> Selectionnez...</option>
							    ...
							    <?php foreach($options_types_list as $options_types) :?>
										<option <?php  if($option_type_id==$options_types->option_type_id){ echo"selected";} ?> value="<?php echo $options_types->option_type_id;?>"> <?php echo $options_types->option_type_name;?></option>
										 <?php endforeach; ?>
					</select> 
							</div>
						</div>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="name" class="form-control" type="text"  name="option_name" value="<?php echo $option_name;?>">
              </div>
			  ...
			  <div class="row">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control"  name="option_price_buying" value="<?php echo $option_price_buying;?>">
                    </div>
                  </div>
				   </div>
			  <div class="form-group">
			  <div class="row">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control"  name="option_price" value="<?php echo $option_price;?>">
                    </div>
                  </div>
				   </div>
