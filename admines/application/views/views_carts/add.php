		...
		<?php if(@$process_status == 1) { ?>
			  ...
			  <option value="">Selectionner</option>
			    ...
			    <?php foreach($customers_list as $customer) :?>
										<option  value="<?php echo $customer->customer_id;?>"> <?php echo $customer->customer_firstname.' '.$customer->customer_firstname;?></option>
										 <?php endforeach; ?>
									</select> </div>
...
$("#categorie_id").change(function() {
	 ...
	 html=  "";
		  jQuery.ajax({
		   url: "<?php echo base_url().'cart/getSubCategoriebyCateg/';?>",
