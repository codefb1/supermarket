  ...
  <button class="btn btn-shadow btn-primary" type="button"onClick="location.href='<?php echo base_url().'countries';?>'"><i class=" fa fa-reply"></i>  Listes des  pays</button>
...
<div class="row">
  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      <div class="panel-heading">Nouveau pays</div>
      <div class="panel-body">
        <form data-parsley-validate="" novalidate=""id="submitpage"  method="POST" action="<?=base_url().'countries/add';?>">
		...
		<?php if(@$process_status == 1) { ?>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="name" class="form-control" type="text"  name="country_name" value="<?php echo $country_name;?>">
              </div>
