...
<div class="row">
  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form data-parsley-validate="" novalidate=""id="submitpage"  method="POST" action="<?=base_url().'products/addComposer';?>">
  ...
  <div class="row">
			  ...
			  <option value=""> Selectionnez une catégorie...</option>
			    ...
			    <?php foreach($categories_list as $categorie) :?>
										<option  value="<?php echo $categorie->categorie_couffin_id;?>"> <?php echo $categorie->categorie_couffin_name;?></option>
										 <?php endforeach; ?>
									</select> </div>
  ...
  <div class="row">
			  ...
			  <option value=""> Selectionnez une certification...</option>
			    ...
			    <?php foreach($certificats_list as $certificats) :?>
										<option  value="<?php echo $certificats->certificat_id;?>"> <?php echo $certificats->certificat_name;?></option>
										 <?php endforeach; ?>
									</select> </div>
            ...
            <div class="row">
              <div class="col-lg-12">
				...
				<div class="row">
								...
								<div class="col-md-12">
							     <textarea  id="product_short_text" name="product_short_text"><?php echo $product_short_text;?></textarea>
  ...
  <div class="row">
	 ...
	 <div class="col-lg-12"><h4 class="widget-title"><b>List des produits</b></h4></div>
		<div class="col-lg-12">
            ...
            <div class="row">
              <div class="col-lg-12">
                <label  for="F1">Poids TTC  (kg)</b></label>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="product_price_selling" class="form-control" type="text" data-parsley-required="true" data-parsley-type="alphanum" name="product_price_selling" value="<?php echo (number_format($products->product_price_selling, 2, ',', '')) ?>">
              </div>
  ...
  <div class="form-group" >
			   ...
			   <div class="col-sm-12">
				  ...
				  <div id="progressbar" class="uk-progress uk-hidden">
					<div class="uk-progress-bar" style="width: 0%;">...</div>
              		  ...
              		  <div class="form-group" id="block-products" style="display:none;">
					  <div class="row">
			   <div class="col-sm-12">
					<div class="dz-preview dz-processing dz-error dz-image-preview example-preview animated fadeInRight"  >
						<div class="dz-details">
							<img data-dz-thumbnail="" alt="avatar" id="block-image-products" src="<?php echo base_url().'medias/products/'.$product_picture; ?>" class="img-responsive">
						</div>
          ...
          <input type="hidden" id="product_picture" name="product_picture" value="" />
   <input type="hidden" id="list_product_selectioner" name="list_product_selectioner" value="" />
		...
		<div class="form-sep">
            <div class="pull-right">
              <A class="btn btn-success addComposer" id=""><i class="glyphicon glyphicon-ok"></i> <span>Enregistrer</span></A>
            </div>
          </div>
     </br> </br>
    </div>
...
$('.addComposer').click(function(e){
			...
			$.ajax({
				...
				success : function (data){
					...
					window.location.href = "<?php echo base_url().'products/addCompose/1';?>";
				}
			});
		});
