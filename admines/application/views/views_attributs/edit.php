...
<div class="row">
  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      <div class="panel-heading">Editer attribut</div>
      <div class="panel-body">
        <form data-parsley-validate="" novalidate=""id="submitpage"  method="POST" action="<?=base_url().'attributs/edit';?>">
		...
		<?php if(@$this->uri->segment(3) == 1) { ?>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="name" class="form-control" type="text"  name="attribut_name" value="<?php echo $attribut->attribut_name;?>">
              </div>
			   ...
			   <div class="row">
				  ...
				  <div id="progressbar" class="uk-progress uk-hidden">
					<div class="uk-progress-bar" style="width: 0%;">...</div>
              		  ...
              		  <div class="form-group" id="block-attribut" >
			   <div class="row">
					<div class="dz-preview dz-processing dz-error dz-image-preview example-preview animated fadeInRight"  >
						<div class="dz-details">
						<img data-dz-thumbnail="" style="width: 20%;" alt="avatar" id="block-image-attribut" src="<?php echo base_url().'medias/attributs/'. $attribut->attribut_picture;; ?>" class="img-responsive">
			...
			<input type="hidden" id="attribut_picture" name="attribut_picture" value="<?=$categorie->attribut_picture;?>" />
			    
                 
				              
		 <input type="hidden" class="form-control" name="attribut_id" id="attribut_id" value="<?=$attribut->attribut_id;?>">
