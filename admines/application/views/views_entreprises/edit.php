  ...
  <button class="btn btn-shadow btn-primary" type="button"onClick="location.href='<?php echo base_url().'entreprises';?>'"><i class=" fa fa-reply"></i>  Liste des  actualités</button>
...
<div class="row">
  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      <div class="panel-heading">Editer actualité</div>
      <div class="panel-body">
        <form data-parsley-validate="" novalidate=""id="submitpage"  method="POST" action="<?=base_url().'entreprises/edit';?>">
		...
		<?php if(@$process_status == 1) { ?>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <input id="entreprise_title" class="form-control" type="text" data-parsley-required="true" data-parsley-type="alphanum" name="entreprise_title" value="<?php echo $entreprise->entreprise_title;?>">
              </div>
			   ...
			   <div class="col-sm-12">
				  ...
				  <div id="progressbar" class="uk-progress uk-hidden">
					<div class="uk-progress-bar" style="width: 0%;">...</div>
              		  ...
              		  <div class="form-group" id="block-entreprises">
					  <div class="row">
			   <div class="col-sm-12">
					<div class="dz-preview dz-processing dz-error dz-image-preview example-preview animated fadeInRight"  >
						<div class="dz-details">
							<img data-dz-thumbnail="" alt="avatar" id="block-image-entreprises" src="<?php echo base_url().'medias/entreprises/'.$entreprise->entreprise_picture; ?>" class="img-responsive">
						</div>
		 ...
		 <input type="hidden" class="form-control" name="entreprise_id" id="banner_id" value="<?=$entreprise->entreprise_id;?>">
							  	<input type="hidden" id="entreprise_picture" name="entreprise_picture" value="<?=$entreprise->entreprise_picture;?>" />
    ...
    $(function(){
        ...
        var progressbar = $("#progressbar"),
            ...
            allcomplete: function(response) {
				...
				$("#block-image-entreprises").attr("src","<?php echo base_url().'medias/entreprises/'; ?>"+response);
				$("#block-entreprises").show();
                setTimeout(function(){
