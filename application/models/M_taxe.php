...
Class M_taxe extends CI_Model {
	
public $table='av_taxe';
public $field_id='taxe_id';
public $taxe_data_status='taxe_data_status';
		...
		function get_this($param_id){
			...
			try {
				...
				$query = $this->db->get_where($this->table, array($this->taxe_data_status => 1));
