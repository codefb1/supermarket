 ...
 <div class="sidebar-block">
                                           ...
                                           <div class="block-content">
												  ...
												  <div class="cateTitle hasSubCategory open level1" >
                                                   ...
                                                   <a class="cateItem" href="javascript:void(0)">     
												   <input  <?php  if($this->session->userdata('filtre_boucherie_certif')  and in_array($certificats->certificat_id, $this->session->userdata('filtre_boucherie_certif'))){ } else  { ?> checked <?php   } ?> type="checkbox" id="filtre" class="filtre_boucherie_certif certification_<?php echo $certificats->certificat_id;?>" name="certificat" value="<?php echo $certificats->certificat_id;?>">
										  ...
										  <div class="sidebar-block">
                                           ...
                                           <div class="block-content">
												 ...
												 <div class="cateTitle hasSubCategory open level1">
                                                    ...
                                                    <a class="cateItem" href="javascript:void(0)"> 
													<input <?php  if($this->session->userdata('product_boucherie_bio')) { } else  {  ?> checked <?php   } ?> type="checkbox" data-type="bio" id="filtre" class="filtre_boucherie_label labels_2" name="avg" value="2">
												 ...
												 <div class="cateTitle hasSubCategory open level1" >
                                                    ...
                                                    <a class="cateItem" href="javascript:void(0)"> <input   <?php  if($this->session->userdata('product_boucherie_label_rouge')) { } else  {  ?> checked <?php   } ?>  type="checkbox" data-type="lr" id="filtre" class="filtre_boucherie_label labels_0" name="avg" value="3">
