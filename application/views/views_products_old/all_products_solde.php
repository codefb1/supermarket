<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
                            ...
                            <div class="content" style="margin-top: 2rem;">
                                <div class="row">
                                    <div class="sidebar-3 sidebar-collection col-lg-3 col-md-4 col-sm-4">
										 ...
										 <div class="sidebar-block">
                                           ...
                                           <div class="block-content">
												  ...
												  <div class="cateTitle hasSubCategory open level1" >
                                                   ...
                                                   <a class="cateItem" href="javascript:void(0)"><input  <?php  if(  $this->session->userdata('all_product_categorie_solde')  and in_array($categorie->categorie_id, $this->session->userdata('all_product_categorie_solde'))){  ?> checked <?php   } ?> type="checkbox" id="filtre" data-search="all" class="all_filtre_categorie_solde sub_categorie_<?php echo $categorie->categorie_id;?>" name="categorie" value="<?php echo $categorie->categorie_id;?>" >
												   
												   <?php  if(  $this->session->userdata('all_product_categorie_solde')  and in_array($categorie->categorie_id, $this->session->userdata('all_product_categorie'))){  ?> 
												  ...
												  <?php endforeach; ?>
												   <div class="cateTitle hasSubCategory open level1" >
												  <a class="cateItem" href="javascript:void(0)"> <input  type="checkbox" id="filtre" class="check_all_product_clear_solde sub_categorie_0"   name="categorie" value="1">
									    ...
									    <?php $this->load->view('views_menus/all_filtre_products_solde.php');?>
                                        <!-- end Filtre -->
        ...
        function loadMore(page,per_page){
          ...
          $.ajax(
                {
                    url: '<?php echo base_url(); ?>products/solde/'+page,
                    type: "GET",
					data: {page:page},
                    beforeSend: function()
                    {
