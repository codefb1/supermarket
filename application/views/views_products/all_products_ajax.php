														 ...
														 <a href="#mpquickview" class="mpquickview-button mpquickview"  data-id="<?php echo $products->product_id;?>" title="<?php echo $products->product_name;?>">
                                                            ...
                                                            <div class="product-description">
                                                                ...
                                                                <span class="product-weight"> <?php  if($products->show_poids) { ?><?php echo $products->product_poids;?> kg<?php  } ?></span>
																   ...
																   <?php  if($products->product_is_promo==2){?>
                                                                <div class="product_price_kg"> <p><span>   <?php  if($products->show_poids) {  echo product_price_kg ($products->product_price_dicount,$products->product_poids);  }  ?></span></p>  </div>
                                                                           <?php } else { ?>
														      					<div class="product_price_kg"> <p><span>   <?php  if($products->show_poids) {  echo product_price_kg ($products->product_price_selling,$products->product_poids);  }  ?></span></p>  </div>
                                                           <?php } ?>
                                                            </div>
