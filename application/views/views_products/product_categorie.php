 <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    ...
    <!-- <div class="section spacing-10 group-image-special block-boucherie" >
                                ...
                                <div class="breadcrumb">
                                    <ol>
										...
										<li  class="breadcrumb-title">
                                            <a href="#">
                                                <span><?php echo $categorieInfo->categorie_name?></span>
                                            </a>
                                        </li>
                                    </ol>
                                </div>
                                ...
                                <div class="row">
								 <?php if($categorieInfo->categorie_id!=101){  ?>
                                    <div class="sidebar-3 sidebar-collection col-lg-3 col-md-4 col-sm-4">
									    ...
									    <?php $this->load->view('views_menus/filtre_products_categorie.php',$categories_list);?>
                                        <!-- end Filtre -->
		...
		var categorieId =<?=$categorieInfo->categorie_id;?>;
		
        $(window).scroll(function() {
            if($(window).scrollTop() + $(window).height() >= $(document).height()- 300) {
                page++;
                if(page < total_pages) {
                    loadMore(page,per_page,categorieId);
                }
            }
        });
    
        function loadMore(page,per_page,categorieId){
			
			var page=page*per_page;
          $.ajax(
                {
                    url: '<?php echo base_url(); ?>products/categorie/'+categorieId+'/'+page,
                    type: "GET",
					data: {page:page},
                    beforeSend: function()
                    {
