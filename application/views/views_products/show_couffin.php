       <div class="page-home detail_product detail_couffin">
                                ...
                                <div class="breadcrumb">
                                    <ol>
                                        <li class="breadcrumb-home">
										 ...
										 <li class="breadcrumb-home">
                                            <a href="<?php echo base_url().'couffin/products/'.$categorieInfo_couffin->categorie_couffin_id.'-'.strtolower(url_title($categorieInfo_couffin->categorie_couffin_name));?>">
                                                <span> <?php echo $categorieInfo_couffin->categorie_couffin_name;?> </span>
                                            </a>
                                        </li>
                        ...
                        <div class="container">
							...
							<h1> Couffin <b><?php  $product_name = explode(" ", $product->product_name); echo $product_name[1]; ?> !</b></h1>
							<p> <?php echo $product->product_short_description; ?>
							</div>
                                <div class="row">
                                    <div class="col-sm-12 col-lg-12 col-md-12">
                                        ...
                                        <div class="main-product-detail">
                                            ...
                                            <div class="product-single row">
                                                        ...
                                                        <div class="images-container">
															  ...
															  <div class="js-qv-mask mask tab-content ">
                                                                ...
                                                                <div id="item<?php echo $product->product_id?>" class="tab-pane fade  active in show ">
                                                                    <img src="<?php echo base_url().'admines/medias/products/'.$product->product_picture;?>" alt="<?php echo $product->product_name;?>" class="border_right">
                                                                </div>
																<?php  foreach ($packs_products as $packs_product):?>
															
                                                                <div id="item<?php echo $packs_product->product_id?>" class="tab-pane fade">
                                                                    <img src="<?php echo base_url().'admines/medias/products/'.$packs_product->product_picture;?>" alt="<?php echo $packs_product->product_name;?>" class="border_right">
                                                                </div>
																 <?php $i++; endforeach; ?>
                                                               
                                                               
                                                              
                                                             <div class="layer hidden-sm-down" data-toggle="modal" data-target="#product-modal" style='transform: rotate(0deg);font-size: 12px;color: #d64652!important;'>
															   ...
															   <ul class="product-tab nav nav-tabs d-flex">
                                                                ...
                                                                <li class="active  col">
                                                                    <a  href="#item<?php echo $product->product_id?>" data-toggle="tab" aria-expanded="true"  >
                                                                        <img src="<?php echo base_url().'admines/medias/products/'.$product->product_picture;?>" alt="<?php echo $product->product_name;?>" class="productComposer"  data-id="">
                                                                    </a>
                                                                </li>
																 	<?php  foreach ($packs_products as $packs_product):?>
                                                                <li class="col">
                                                                    <a  href="#item<?php echo $packs_product->product_id?>" data-toggle="tab" aria-expanded="true"  >
                                                                        <img src="<?php echo base_url().'admines/medias/products/'.$packs_product->product_picture;?>" alt="<?php echo $packs_product->product_name;?>" class="productComposer"  data-id="<?php echo $packs_product->product_compose_id;?>">
                                                                    </a>
                                                                </li>
																 <?php $i++; endforeach; ?>
													     ...
													     <div class="modal fade" id="product-modal" role="dialog">
                                                                                    ...
                                                                                    <div>
                                                                                        <div class="images-container">
                                                                                            <div class="js-qv-mask mask tab-content">
																										...
																										<?php  foreach ($packs_products as $packs_product):?>
																										<div id="modal-item<?php echo $packs_product->product_id?>" class="tab-pane">
																										<img src="<?php echo base_url().'admines/medias/products/'.$packs_product->product_picture;?>" alt="<?php echo $packs_product->product_name;?>">
																										
																										<h2 style="text-align: center;font-size: 14px;"><?php echo $packs_product->product_name?>  avec poids de <span style="color: #d64652;"><?php echo $packs_product->prod_poids?> kg</span>  </h2>
																										</div>
																										 <?php  endforeach; ?>
                                                                                            ...
                                                                                            <ul class="product-tab nav nav-tabs">
																											...
																											<img src="<?php echo base_url().'admines/medias/products/'.$product->product_picture;?>" alt="<?php echo $product->product_name;?>">
																												...
																												<li>
																												<a href="#modal-item<?php echo $packs_product->product_id?>" data-toggle="tab">
																												<img src="<?php echo base_url().'admines/medias/products/'.$packs_product->product_picture;?>" alt="<?php echo $packs_product->product_name;?>">
																												</a>
																												</li>
																										 <?php  endforeach; ?>
															   ...
															   <div class="col-sm-12 col-lg-12 col-md-12 product_composer_info"> 
															    <div id="product_name_composer"><span class="product_name_composer"><span></div>
															     <div id="product_poids_composer"><span class="product_poids_composer"><span></div>
															      <div id="product_info_composer"><span class="product_info_composer"><span></div>
															  
															       <div id="product_short_description_composer"><span class="product_short_description_composer"><span></div>
															    <div id="label_certification_info"></div>
                                                ...
                                                <div class="product-info col-xs-12 col-md-7 col-sm-7">
												 <h1 class="show_pc" style="border-bottom: 1px solid #dee2e6!important;"><?php echo $product->product_name; ?></h1>
												<div id="deleviry " style="display:none;">
                                                    ...
                                                    <div class="detail-description">
														...
														<?php  if($product->product_is_promo==2){?>
                                                          <div id="price_title" class="product_price"> <div><span class="price_title"> Prix  :   </span><span class="price" style="color: #d64652!important;">  <?php echo (number_format($product->product_price_dicount, 2, ',', ''))?> €</span> <span class=" solde" style="">  <?php echo (number_format($product->product_price_selling, 2, ',', ''))?> €</span></div></div>
														   <div id="price_title" class="product_price">
                                                               <div>
                                                                   <span class="price_title"> Poids  :   </span><span class="price" style="color: #d64652!important;">  <?php echo $product->product_poids;?> kg</span>
                                                                   </div>
                                                           </div>
														   <?php  } else {  ?>
                                                          <div id="price_title" class="product_price"> <div><span class="price_title"> Prix  :   </span><span class="price" style="color: #d64652!important;">  <?php echo (number_format($product->product_price_selling, 2, ',', ''))?> €</span></div></div>
														   <div id="price_title" class="product_price"> <div><span class="price_title"> Poids  :   </span><span class="price" style="color: #d64652!important;">  <?php echo $product->product_poids;?> kg</span>
                                                               </div>
                                                           </div>
                                                                    ...
                                                                    <div class="input-group">
                                                                        <div class="quantity">
																		  ...
																		  <span class="control-label label_product_qty">Quantité : </span>
                                                                            <input type="text" name="qty" id="quantity_wanted"  min="1" value="1" class="input-group form-control qty">
                                                                        </div>
																			<?php  if($product->product_is_promo==2){?>
										...
										<h2 class="product-pack" ><span>Détail couffin <?php echo $product_name[1]; ?></span> </h2>
	<div class="col-xs-12 col-md-1 col-sm-1">  </div>
									<div class="col-xs-12 col-md-10 col-sm-10">
                                         <div class="row list_product_pack">
										 <?php $i=1;  foreach ($packs_products as $packs_product):   ?>
                             <div class="col-xs-12 col-md-3 col-sm-3">
							  <div class="row <?php if ($i % 4 != 0) { echo 'border_right'; }?>  ">
							  	  <a href="<?php echo base_url().'products/show/'.$packs_product->product_id.'-'.strtolower(url_title($packs_product->product_name));?>">
	  <img src="<?php echo base_url().'admines/medias/products/'.$packs_product->product_picture;?>" class="img-fluid "  alt="<?php echo $packs_product->product_namet;?>"></a></td>
      
							 </div>
							  <div class="row info_pack">
							  <h2><?php echo $packs_product->product_name;?></h2>
							  <p>Poid : <b><?php echo $packs_product->prod_poids;?> KG</b></p>
							 </div>
...
<?php $catePoids=[]; foreach ($categories_list as $cate):   ?>	
		  <?php $poisTotal=0;  foreach ($packs_products as $packs_product):  	
		   if($cate->categorie_id==$packs_product->categorie_id){
			  $poisTotal+=$packs_product->prod_poids;
		   }
		    $catePoids[$cate->categorie_name]=$poisTotal; 
		  endforeach; ?>
		 <?php $i++; endforeach; ?>
	<?php if($catePoids){		?>
<table class="table" style="text-align: center;">
 <thead>
    <tr>
	<?php  foreach ($catePoids as $catePoid =>$cp):   ?>	
	<?php if($cp >0){		?>
      <th scope="col"> <span style="color: #d64652!important;"><?php echo $catePoid;?></span> :  <?php echo $cp;?> KG </th>
	  <?php }		?>
    <?php $i++; endforeach; ?>
    </tr>
  </thead>
	...
	<?php }		?>
									...
									</div><div class="col-xs-12 col-md-1 col-sm-1">  </div>
