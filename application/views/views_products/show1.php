															...
															<?php } else { ?>
															  <div class="js-qv-mask mask tab-content ">
                                                                ...
                                                                <div id="item<?php echo $packs_product->product_id?>" class="tab-pane fade">
                                                                    <img src="<?php echo base_url().'admines/medias/products/'.$packs_product->product_picture;?>" alt="<?php echo $packs_product->product_namet;?>">
                                                                </div>
																 <?php $i++; endforeach; ?>
                                                         ...
                                                         <div id="price_title"> <span class="price_title"> Prix </span> </div>
														  ...
														  <span class="price product-price-old-show" style="color: #000 !important;">€ <?php echo (number_format($product->product_price_selling, 2, ',', ''))?> <?php  if($product->show_poids) { ?><span></span> <?php  } ?></span>
														   ...
														   <div> <span class="price">€ <?php echo (number_format($product->product_price_dicount, 2, ',', ''))?>  <?php  if($product->show_poids) { ?><span>(<?php echo $product->product_poids;?> kg)</span> <?php  } ?></span> </div>
															...
															<div> <p><span> 
															  <?php  if($product->show_poids) { ?> <?php echo product_price_kg ($product->product_price_dicount,$product->product_poids);?> <?php  }  ?></span></p>  </div>
														  ...
														  <p style="display: block;font-size: 12px;color: #a71d1a;" >
														...
														<div class="price-del ">
                                                          <div id="price_title"> <span class="price_title"> Prix </span> </div>
														    <div> <p><span class="price">€ <?php echo (number_format($product->product_price_selling, 2, ',', ''))?>  <?php  if($product->show_poids) { ?><span>(<?php echo $product->product_poids;?> kg)</span> <?php  } ?></span></p>  </div>
                                                             <?php  if($product->show_poids and  $product->product_poids!=1) { ?>
															<div> <p><span> <?php echo product_price_kg ($product->product_price_selling,$product->product_poids);?> </span></p>  </div>
                                                             <?php  }  ?>
														  <?php  if($product->product_stock==2 or  $product->product_stock==3){?>
															<span class="float-right" style="display:none;">
                                                                <span class="availb">Disponibilité: </span>
								...
								<?php  if($product->product_stock!=2){ ?>
												...
												<?php  echo $product->product_short_text; ?>
													...
													<?php  } ?>
															...
															<?php if($product->product_is_composer==2){?>
										<h2 class="" style="    font-size: 16px;
    text-align: center;
    width: 100%;
    color: #d64652!important;">Détail <?php echo $product->product_name; ?> </h2>
  ...
  <thead>
    <tr>
      ...
      <th scope="col" style="TEXT-ALIGN: CENTER;">Labels</th>
  ...
  <?php  foreach ($packs_products as $packs_product):   ?>
    <tr>
	  ...
	  </a><img src="<?php echo base_url().'admines/medias/products/'.$packs_product->product_picture;?>" class="img-fluid img-thumbnail"  alt="<?php echo $packs_product->product_namet;?>"></a></td>
      <td style="width: 15%;" >  <a href="<?php echo base_url().'products/show/'.$packs_product->product_id.'-'.strtolower(url_title($packs_product->product_name));?>"> <?php echo $packs_product->product_name;?></a></td>
      <td  style="width: 10%;" ><?php echo $packs_product->prod_poids;?> kg</td>
	  <th scope="col" style="width: 20%;">
	  	<div class="product-attribut">
												
												<?php  if($packs_product->prod_label_rouge==2){ ?>
												<span class="product-option"><img class="img-fluid" style="width: 50px;" src="<?php echo base_url().'template/';?>img/label-rouge.png" alt="Produits AVS"></span>	
												 ...
												 <?php  } ?>
												  	...
												  	<?php  if($packs_product->prod_bio==2){ ?>
												<span class="product-option"><img class="img-fluid" src="<?php echo base_url().'template/';?>img/bio_3.png" alt="Produit Biologique"></span>	
	   ...
	   <td  style="width: 10%;" ><?php echo $packs_product->product_short_description;?> </td>
    </tr>
   <?php $i++; endforeach; ?>
