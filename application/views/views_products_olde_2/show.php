                                                                                    ...
                                                                                    <div>
                                                                                        <div class="images-container">
                                                                                            <div class="js-qv-mask mask tab-content">
																										...
																										<H2 style="text-align: center;font-size: 14px;"><?php echo $packs_product->product_name?>  avec poids de <span style="color: #d64652;"><?php echo $packs_product->prod_poids* $packs_product->prod_qty?> kg</span>  </H2>
																										</div>
																										 <?php  endforeach; ?>
