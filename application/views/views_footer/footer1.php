                       ...
                       <div class="col-lg-3 col-md-6 col-xs-6 col-mxl-6">
                            <div class="block">
                                ...
                                <li>
									...
									<?php endforeach; ?>
                                        <li>
                                            <a href="#"><i class="fa fa-angle-double-right"></i> Meuilleures ventes</a>
                                        </li>
                                        <li>
                                            <a href="#"><i class="fa fa-angle-double-right"></i> Plus recommandés</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
						...
						<?php }else{ ?>
						               ...
						               <?php } ?>
                                        ...
                                        <li>
                                            <a href="<?php echo base_url().'contact';?>"> <i class="fa fa-angle-double-right"></i> Service client</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
						  ...
						  <div class="tiva-modules col-lg-3 col-md-6">
						   ...
						   <div class="tiva-modules col-lg-3 col-md-6">
                                ...
                                <div class="block-content">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="<?php echo base_url().'pages/show/';?>6-qui-somme-nous"> <i class="fa fa-angle-double-right"></i> Qui sommes nous?</a>
                                        </li>
                                        <li>
										...
										<li>
                                            <a href="<?php echo base_url().'pages/show/';?>12-certification"> <i class="fa fa-angle-double-right"></i> Nos certifications</a>
                                        </li>
										<li>
