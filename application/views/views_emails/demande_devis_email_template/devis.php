        ...
        <tr>
          <td><!-- START OF Header Table -->
            ...
            <table width="633" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #7a7a7a; line-height: 18px;"><p> <b>Bonjour</b>, <b><?php echo $orders['s_order_deliver_to']; ?></b></p>
                  </p>
                  <p>Nous avons bien reçu votre demande de devis<br />
                    Votre demande a été enregisitrée sous la référence <b><?php echo "DV00".$standard_order_id."-".date_format(date_create($orders['data_created']),'m-Y');?></b> du <b> <?php echo date_fr($orders['data_created']); ?> </b>.<br />
                    Nous reviendrons vers vous dans un délai de 48 à 72h.</p>
                  </br>
                  </br>
                  <p>Cordialement,<br />
                    <br />
                    L'équipe ENERLIS</p></td>
              </tr>
            </table>
            ...
            <table width="633" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="501" align="left" valign="top" style="font-family: Helvetica, sans-serif; font-size: 11px; color: #7a7a7a; line-height: 16px;"><p>&copy; <?PHP echo date('Y'); ?> <a href="http://www.enerlisonline.com" target="_blank">Enerlisonline.com</a><br />
