            ...
            <table width="633" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #7a7a7a; line-height: 18px;"><p style="font-size: 18px; "> 
                  <b>FACTURE  - F<?php echo "00".$order->order_id;?>
                  <p><b>[ INFORMATIONS SUR LE CLIENT ]</b></br>
                  </p>
                  <p style="color: #7a7a7a;font-family: Helvetica,sans-serif;"> <b>Client  :</b> <?php echo echo $orders['order_billing_lastname']." " .$orders['order_billing_firstname']; ?> </p>
                  ...
                  <?php $data_country['countries']=$this->M_countries->get_this($orders['order_billing_country']) ?>
                  <p style="color: #7a7a7a;font-family: Helvetica,sans-serif;"> <b>Pays :</b> <?php echo $data_country['countries']->country_name; ?> </p>
                  ...
                  <p style="color: #7a7a7a;font-family: Helvetica,sans-serif;"> <b>Adresse de livraision :</b> <?php echo $orders['order_shipping_street']." " .$orders['order_shipping_zip']." " .$orders['order_shipping_city']; ?> </p>
                   <?php $data_country['countries']=$this->M_countries->get_this($orders['order_shipping_country']) ?>
                   <p style="color: #7a7a7a;font-family: Helvetica,sans-serif;"> <b>Pays :</b> <?php echo $data_country['countries']->country_name; ?> </p>
