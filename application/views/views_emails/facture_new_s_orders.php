<page  style="margin:0;padding:0"  backtop="25mm" backbottom="25mm" backleft="0" backright="0">
  <page_header>
    <table>
      <tr>
        ...
        <td height="67" width="400"  align="left" valign="middle" bgcolor="#FFFFFF" style="color: #000000;word-spacing: 5px;; font-family: Helvetica, sans-serif; font-size: 18px; letter-spacing: 0px;"><div  style="word-spacing: 5px; text-align:right ;"><strong>Facture Réf# F
            <?=$OREF?>
            </strong></div></td>
      </tr>
      <tr >
  ...
  <table style="width:450px ; hight:450px ;    " >
    <tr style="width:450px ; hight:450px ;    " >
      <td  style="width:450px ;   hight:450px ;    " ><table  style=" border: 1 ; ;padding:15px; " >
          <tr >
          ...
          <tr >
            <td style="width: 250px ; height:20px ; font-size: 13px;    " ><?=$ODL;?></td>
		       ...
		       <tr >
            <td style="width: 250px ; height:20px ; font-size: 13px;    " ><?=$ODLCV;?></td>
          </tr>
          <tr >
            <td style="width: 250px ; height:20px ; font-size: 13px;    " ><?=$CADDL;?></td>
          </tr>
          <tr >
      ...
      <td   bgcolor="#FFFFFF"><table  style=" border: 1 ;padding:15px;" >
          ...
          <tr >
		    ...
		    <tr >
            <td style="width: 250px ; height:20px ; font-size: 13px;    " ><?=$ODCMCV;?></td>
          </tr>
          <tr >
            <td style="width: 250px ; height:20px ; font-size: 13px;    " ><?=$CADDF;?></td>
          </tr>
          <tr >
  ...
  <table  style="border:1px solid black;border-collapse:collapse; " >
    <tr style="background-color: Gainsboro  ;  height:3px ; ">
      <td colspan=3 style="background-color:#F0F0F0 ; border:1px solid black; ; height:3px ;padding:2mm;"><strong>Facture Réf# F
        <?=$OREF?>
        du
        <?=$DTE?>
        </strong></td>
    ...
    <tr  >
      <td style="height:10px ;padding:2mm; border:1px solid black; width: 58mm">Commande Réf : C
        <?=$OREF?></td>
      <td style="width: 58mm ;padding:2mm;;border:1px solid black;"><strong>Transporteur : </strong>
        <?=$TRN?></td>
      <td style="width: 58mm ;border:1px solid black;padding:2mm;;"><strong>Mode de paiement : </strong>
        <?=$PST?></td>
    </tr>
  </table>
  <table>
  ...
  <table  style="border:1px solid black;border-collapse:collapse; " >
    <tr style="background-color: Gainsboro  ;  height:3px ; ">
      <td colspan=3 style="background-color:#F0F0F0 ; border:1px solid black; ; height:3px ;padding:2mm;"><strong>Transporteur</strong></td>
    </tr>
    <tr  >
      <td style="height:10px ;padding:2mm; border:1px solid black; width: 92mm"><strong>Transporteur : </strong>
        <?=$TRN?></td>
      <td style="width: 92mm ;padding:2mm;;border:1px solid black;"><strong>Numéro du suivi : </strong>
        <?=$OTN?></td>
    </tr>
  </table>
  <table>
  ...
  <table style="border-style:solid;border-top:thick double #000000; "  >
    <tr  style="background-color:#F0F0F0;   ; height:5px ;" >
      ...
      <td style="text-align: center;"><strong>Prix unitaire HT </strong></td>
