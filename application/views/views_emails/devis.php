        ...
        <tr>
          <td>
            ...
            <table width="633" border="0" cellspacing="0" cellpadding="0">
              ...
              <p> <b>Bonjour</b>, <b><?php echo $orders['s_order_deliver_to']; ?></b> <br />
              </p>
              <p>Enerlisonline.com vous informe que la réponce sur votre demande de devis  sous la référence  <b><?php echo "DV00".$standard_order_id."-".date_format(date_create($orders['data_created']),'m-Y');?></b>  est en <b> <?php echo date_fr($orders['data_created']); ?> </b>. 
			sera envoyé dans un délai de 24H.</p>
</br></br>
              </p> 
          </td>
              </tr>
