            ...
            <table width="633" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #7a7a7a; line-height: 18px;"><p> <b>Bonjour</b>, <br />
                  ...
                  <p>Une nouvelle demande de devis vient d'être émise via <a href="<?php echo base_url().'enerlisonline';?>">Enerlisonline.com</a> sous la référence <b><?php echo "DV00".$standard_order_id."-".date_format(date_create($orders['data_created']),'m-Y');?></b> par le client <b><?php echo $orders['s_order_deliver_to']; ?></b> à <b> <?php echo date_fr($orders['data_created']); ?> </b> </p>
                  </br>
                  </br>
                  </p></td>
              </tr>
