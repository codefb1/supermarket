        ...
        <tr>
          <td><!-- START OF Header Table -->
            ...
            <table width="633" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #7a7a7a; line-height: 18px;"><br />
                  <p style="font-family: Arial, Helvetica, sans-serif; color: #7a7a7a; font-size: 14px; letter-spacing: -1px;">Bonjour <?php echo $CLN.' '.$CFN?>,<br />
                  </p>
                  <br />
                  <p>Vous trouvez ci-dessous vos donn&eacute;es de connexion qui vous permettront d'acc&eacute;der a votre compte sur Enerlisonline.com en tant que membre <br />
                  </p>
                  <p>URL: <a href="<?php echo base_url().'index.php/connect/';?>" target="_blank"> http://www.enerlisonline.com</a> <br />
                  </p>
                  <p>Identifiant :
                    <?=$CM?>
                    <br />
                  ...
                  <br />
                  <p>Nous espérons vous retrouver trés bientôt. </p></td>
              </tr>
            </table>
