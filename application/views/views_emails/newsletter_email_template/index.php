        ...
        <tr>
          <td><!-- START OF Header Table -->
            ...
            <table width="633" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td   align="left" valign="middle" bgcolor="#FFFFFF" style="color: #e3e3e3; font-family: Helvetica, sans-serif; font-size: 12px; letter-spacing: 0px;"><a title="enerlisonline.com" href="<?php echo base_url(); ?>"><img src="<?php echo base_url().'template/'; ?>images/logo-mail.png" alt=""/></a></td>
              </tr>
            </table>
            ...
            <table width="633" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #7a7a7a; line-height: 18px;"><br />
                  <p>Bienvenue sur ENERLISONLINE.COM,  votre compte est désormais activé. <br />
                  </p>
                  <p>Identifiant :
                    <?=$customer_email?>
                    <br />
