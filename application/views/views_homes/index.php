	...
	<div class="swiper-container mySwiper" style="z-index: 0;">   </div>
	  ...
	  <?php foreach($slider_list as $slider) :?>
	   ...
	   <div class="effect">   
		<a style="width:100%" href="<?php  echo base_url().'couffin/'?>" title="<?php echo $slider->banner_title;?>">
                                             <img  src="<?php echo base_url().'admines/medias/banners/'.$slider->banner_picture;?>" alt="<?php echo $slider->banner_title;?>" title="<?php echo $slider->banner_title;?>" style="width: 100%;">
                                     </a>
              ...
              <p class="text-2 text_un" style=""><?php echo $slider->banner_text;?></p> 
							...
							<p class="text-2 text_troix"><?php echo $slider->banner_text_troix;?></p>
			  						<p><a title="<?php echo $slider->banner_title;?>" href="<?php  echo base_url().'couffin/'?>" class="btn btn-primary"><?php echo $slider->banner_botton_text;?></a></p>
                            </div>
                        </div>
                    </div>
									 </div>
							...
							<div class="title">
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 " style="padding-top: 10px;">
												<a href="<?php echo base_url().'products/couffin';?>" title="j'ai d'autre plan ?" class="autre_oouffa">j'ai d'autre plan ? >></a>
                                           </div>
                              </div>
                        </div>
                    </section>
                                       ...
                                       <?php  if($products_best_seller_list) { ?>	
                                           <div class="sidebar-block best-seller">
                                            <div class="title-block">
                                                Meilleures <span>Ventes</span><hr/>
                                            </div>
                                                    ...
                                                    <div id="grid" class="tab-pane fade in active show">
														...
														<a href="#mpquickview" class="mpquickview-button mpquickview"  data-id="<?php echo $products->product_id;?>" title="<?php echo $products->product_name;?>">
                                                            ...
                                                            <div class="product-description">
                                                              ...
                                                              <span>   <?php  if($products->show_poids) {  echo product_price_kg ($products->product_price_dicount,$products->product_poids);  }  ?></span>
                                                                           <?php } else { ?>
														      					<span>   <?php  if($products->show_poids) {  echo product_price_kg ($products->product_price_selling,$products->product_poids);  }  ?></span>
                                                           <?php } ?>
                                                            </div> </div>
															  <div class="product-title" >
										...
										<div class="col-lg-6 col-md-6 col-sm-6 left">
											<div class="cms-block f-right">
												...
												<?php echo $blocksTree->home_block_text;?>
													<a href="<?php   echo base_url().'associations/don' ?>" class="btn btn-primary"><?php echo $blocksTree->home_block_botton_text;?></a>
...
<div class="row">
				...
				<div class="row">
							 ...
							 <h3>Viande Halal </h3>
							 <p>Des viandes Halal et certifiées AVS !  </p>
							 </div>
							 </div>
							 ...
							 <p>Des viandes halal origine France !  </p>
							 </div>
							 </div>
							 ...
							 <p>Une livraison rapide dans les meilleures conditions !  </p>
							 </div>
							 </div>
