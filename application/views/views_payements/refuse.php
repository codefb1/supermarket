    ...
    TEXT-ALIGN: CENTER;">
 Tu as décidé d’abandonner le processus de paiement 
</div>
						...
						<!-- fieldsets -->
                            ...
                            <div class="cart-grid row hidden_panier">
									...
									<?php $totalCarts=0;$totalOptionPrice=0; foreach ($this->cart->contents() as $items):
                                        ...
                                        <div class="cart-detailed-totals">
                                          ...
                                          <div >  <span class="cart-products-count"> <?php echo count($this->cart->contents()); ?> article(s)</span> </div>
										      ...
										      <div   class="cart-summary-line cart-subtotal-shipping-ht">
                                                <span class="label">
                                                    Frais de livraison HT dés € :
                                                </span>
                                                <span class="value shipping_price_ttc totalCartsTVA" style="display: block;">  <?php echo  number_format($transporters->transporter_price_in_france*(1-$taxe), 2, ',', '') ;?></span>
                                                <div>
                                   ...
                                   <span><img src="<?php echo base_url();?>template/img/home/cb.jpg" style="" class="carte" alt="CB">
											...
											<a href="<?php echo base_url().'checkout/login';?>" class=" btn btn-primary pull-xs-right action_checkout" style="padding-right: 7px; padding-left: 7px;">
                                        Valider mon panier
                                    </a> </div>
									 <?php }else{ ?>
									 			   <div id="block-checkout" >
											<a href="<?php echo base_url().'checkout';?>" class=" btn btn-primary pull-xs-right action_checkout" style="padding-right: 7px; padding-left: 7px;">
                                        Valider mon panier
                                    </a> </div>
									      <?php } ?>
                                        </div>
                                ...
                                <div class="col-md-9 col-xs-12 check-info check-cart">
									  ...
									  <ul id="progressbar" class="progressbar_cart" style="">
																	...
																	<li  class="active" id="panier" ><strong  class="tilte_progressbar"></strong> <strong>1-Panier</strong></li>
																   
																	<li id="delivery"><strong class="tilte_progressbar" ></strong><strong>2-Livraison</strong></li>
																 
																   <li id="payment" ><strong class="tilte_progressbar" ></strong><strong>3-Paiement</strong></li>
																</ul> 
                                    ...
                                    <div class="cart-container">
                                        ...
                                        <table class="std table table_cart cart_table">
												   ...
												   <div class="row">
													<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
														<?php if($items['options']['product']->product_entier_association){  ?>
																	<a href="javascript:;"><img  class="img-fluid" src="<?php echo $path ;?>" alt="<?php echo  $items['options']['product']->product_name;?>"></a>
													...
													<?php  }  ?>
														...
														<?php if($items['options']['product']->product_entier_association){  ?>
														 <a class="label cart_product_name" style="position: relative;top: 35%;" href="javascript:;" data-id_customization="0"><?php echo  $items['name'];?></a>
                                                         
													<?php  } else {  ?>
													<a class="label cart_product_name" style="position: relative;top: 35%;" href="<?php echo base_url().'products/show/'.$items['options']['product']->product_id.'-'.strtolower(url_title($items['options']['product']->product_name));?>" data-id_customization="0"><?php echo  $items['options']['product']->product_name;?></a>
                                                         
													<?php  }  ?>
														</div>
														<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
											   <a class="edit-from-cart" onclick="edit_item('<?php echo $items['rowid'];?>');" rel="nofollow" href="javascript:;" data-link-action="edit-from-cart" data-id-product="1" >
                                                                          
																			<i class="fa fa-edit"></i>
                                                                        </a>
                                                     <a class="remove-from-cart" onclick="remove_item('<?php echo $items['rowid'];?>');" rel="nofollow" href="javascript:;" data-link-action="delete-from-cart" data-id-product="1" style="top: 37%!important;">
													...
													<?php  }  ?>
													<span class="unitaire_price">€ <?php if ($items['price']>0){  echo number_format($items['price'], 2, ',', '');} else {echo "N.D";}?>       
														 ...
														 <?php if($items['options']['product']->product_info){  ?>
														  ...
														  <?php  }  ?>
																		...
																		<span  class="price_ttc">Prix Total TTC </span>
																		   <span class=" cart_new_price product_price_total_<?php echo  $items['rowid'];?>" >€ <?php if ($items['price']>0){  echo number_format($items['price']*$items['qty'], 2, ',', '');} else {echo "N.D";}?>  </span>     
	                                                  ...
	                                                  <div class="row block_option">
														...
														<div class="col-xs-3 col-sm-2 col-md-2 col-lg-2">
																	  ...
																	  <div class="row">
																	   ...
																	   <span class="option_price" > <?php if ($optionslist['option_price']>0){  echo '€ '.number_format($optionslist['option_price'], 2, ',', '');}?>  </span>
                                                                        ...
                                                                        <?php if ($optionslist['option_price']>0){  echo '€ '.number_format($optionslist['option_price']*$items['qty'], 2, ',', '');}?>
                                          ...
                                          <div >  <span class="cart-products-count"> <?php echo count($this->cart->contents()); ?> article(s)</span> </div></b>
                                               ...
                                               <b>  
                                                <span class="value total_panier_cart">€ <?php echo  number_format($totalCart+$totalOptionPrice, 2, ',', '') ;?></span> </div>
                                          <div > </div></td>
													<td  style="width: 25%;">
											...
											<?php if(($this->session->userdata('logged_in'))!= 1) { ?>
												    <div id='block-checkout'>
											<a href="<?php echo base_url().'checkout/login';?> " class=" btn btn-primary pull-xs-right action_checkout">
                                        Valider mon panier
                                    </a> </div>			  
									 <?php }else{ ?>
									 			      <div id='block-checkout'>
                                        ...
                                        Valider mon panier
                                          ...
                                          <div >  <span class="cart-products-count"> <?php echo count($this->cart->contents()); ?> article(s)</span> </div></b>
										   ...
										   <div class="price_totals">
                                               <b>  
                                                <span class="value total_panier_cart">€ <?php echo  number_format((1-$taxe)*($totalCart+$totalOptionPrice), 2, ',', '') ;?></span> </div>
                                    ...
                                    <div class="cart-summary carts-summary">
                                        <div class="cart-detailed-totals">
                                          ...
                                          <div >  <span class="cart-products-count"> <?php echo count($this->cart->contents()); ?> article(s)</span> </div>
										     ...
										     <div   class="cart-summary-line cart-subtotal-shipping-ht">
                                                <span class="label">
                                                    Frais de livraison (ile de france) HT dés:
                                                </span>
                                                <span class="value shipping_price_ttc" style="display: block;">€ <?php echo  number_format($transporters->transporter_price_in_france*(1-$taxe), 2, ',', '') ;?></span>
                                                <div>
                                                    <small class="value"></small>
                                                </div>
                                            </div>
											 <div   class="cart-summary-line cart-subtotal-shipping-ht">
                                                <span class="label">
                                                    Frais de livraison (Autre) HT dés:
                                                </span>
                                                <span class="value shipping_price_ttc" style="display: block;">€ <?php echo  number_format($transporters->transporter_price_not_france*(1-$taxe), 2, ',', '') ;?></span>
                                                <div>
                                                    <small class="value"></small>
                                                </div>
                                            </div>
                                         ...
                                         <div class="cart-summary-line cart-total">
                                            ...
                                            <div class="cart-summary-line cart-total carts-totals" style="text-align: center;">
