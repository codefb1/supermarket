															  ...
															  <div class="product-description">
                                                                        <div class="product-groups">
                                                                            <div class="product-title product-title-don " align="center">
                                                                                   <h1 align="center">  <?php echo $page_comsommer->page_name;?> </h1>  
                                                                            </div>
                                                        ...
                                                        <div class="product-miniature assosation">
															...
															<div class="col-md-12 col-sm-12 col-lg-12">
															 ...
															 <div class="product-title ">
                                                                                     <h2 class="title-assosacion"><a href="#"> </a></h2> 
                                                                ...
                                                                <div class="col-md-12 col-sm-12 col-lg-12 association-img" >
                                                                    ...
                                                                    <img class="img-fluid image-cover" src="<?php echo base_url().'admines/medias/products/'.$associations->product_picture; ?>" alt="<?php echo $associations->country_name;?>">
                                                                
                                                                    </div>
                                                                </div>
																<div class="col-md-12 col-sm-12 col-lg-12 ">
																<h2><?php echo $associations->product_name; ?></h2>
																<p>( Origine France )</p>
																 </div>
                                                                    ...
                                                                    <div class="product-description">
                                                                        <div class="product-groups">
																			...
																			<div class="product-group-price">
																			  ...
																			  <div class="quantity">
                                                                       <input  id="qty"
																		       class ="product_consommer product_consommer_<?php echo $associations->product_id; ?>"
																			   type="text"
																			   value=1
																			   name="qtyUp"
																			   data-bts-min="1"
                                                              ...
                                                              </div>   <div class="col-md-5 col-sm-5 col-lg-5 block-price">
																	   <div class="product-price-and-shipping"> 
                                                                                       <span class="price">  <?php echo (number_format($associations->product_price_selling, 2, ',', ''))?> €</span>
                                                                        
                                                                                </div>
																	</div>
																			<div class="col-md-3 col-sm-3 col-lg-3 block-panier">
																			<div id="shopping-cart">
																				<button type="button"  style="background: transparent!important;" class="btn btn-default add-to-cart add-cart-association"  data-id="<?php echo $associations->product_id; ?>" data-option="<?php echo $associations->show_option; ?>">
																				<img " src="<?php echo base_url().'template/';?>img/paniers.png" alt="Ajouter au panier">
																	</button>
																			</div>
