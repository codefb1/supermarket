							 ...
							 <div style="text-align: center;">
                                ...
                                <div class="col-md-9 col-xs-12 check-info check-cart">
									  ...
									  <ul id="progressbar" class="progressbar_cart" style="">
																	...
																	<li  class="active" id="panier" ><strong  class="tilte_progressbar">1</strong> <strong>Panier</strong></li>
																   
																	<li id="delivery"><strong class="tilte_progressbar" >2</strong><strong>Livraison</strong></li>
																 
																   <li id="payment" ><strong class="tilte_progressbar" >3</strong><strong>Paiement</strong></li>
																</ul> 
									   
										
										 </div>
										 <div class="row">
							          	<h2 style="font-size: 17px!important;text-align: center!important;width: 100%;">Récapitulatif</h2>
									 </div>
											...
											<tr id="wishlist_1" class="rowid_<?php echo  $items['rowid'];?>">
												   ...
												   <div class="row">
													...
													<?php  }  ?>
														...
														<?php if($items['options']['product']->product_entier_association){  ?>
														 <a class="label cart_product_name" style="position: relative;top: 35%;" href="#" data-id_customization="0"><?php echo  $items['name'];?></a>
                                                     ...
                                                     <a class="remove-from-cart" onclick="remove_item('<?php echo $items['rowid'];?>');" rel="nofollow" href="#" data-link-action="delete-from-cart" data-id-product="1">
														...
														<div class="col-xs-3 col-sm-2 col-md-2 col-lg-2">
														  <div class="quantity quantity_cart">
																	  ...
																	  <div class="row">
																	   <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 block_price_ttc" >
																...
																<?php  if($items['options']['product']->show_poids) { ?>  <span class="">(<?php echo $items['options']['product']->product_poids;?> kg)</span><?php  } ?>
																		 ...
																		 <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 block_price_ttc">
																		  <span  class="price_ttc">Prix Total TTC </span>
																		    <span class=" cart_new_price product_price_total_<?php echo  $items['rowid'];?>" >€ <?php if ($items['price']>0){  echo number_format($items['price']*$items['qty'], 2, ',', '');} else {echo "N.D";}?>       
														 </span>
																	     </div>
																	  </div>
																	   </div>
