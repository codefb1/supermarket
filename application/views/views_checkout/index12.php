                        ...
                        <div id="msform">
						  ...
						  <h1 class="title-page" style="text-align: center!important;"> <span> Bismallah ça prendre que 3mn</span></h1>
                            ...
                            <ul id="progressbar" class="progressbar_cart  progressbar_carts">
							   ...
							   <li id="payment" class="active payments_actvie" style="display:none;"><strong class="mun_progressbar_cart"></strong><strong>4-Paiement</strong></li>
                              </ul> <!-- fieldsets -->
							<div class="row">  <h1 class="typo-title mt-2 title_step_2">Livraison</h1></div>
							<div class="row">  <h1 class="typo-title mt-2 title_step_3"style="display:none;" >PAIEMENT</h1></div>
...
<div class="c_d_phone"><?php echo $this->session->userdata('customer_delivery_phone');?></div>
                            ...
                            <fieldset class="fieldset_block_paiements">
							      <div class="row">
								  <h2 class="fs-title title_facturation">1.Votre adresse de facturation 
									<a class="btn btn-primary up_adress_billing">Modifier</a></h2> 

									    <div  class="col-xs-12 col-sm-12 col-md-12 col-lg-12  "> 
						  <div  class="onecol block-up-facturation">

<div class="c_b_cu"><?php echo $this->session->userdata('customer_delivery_lastname').' '.$this->session->userdata('customer_delivery_firstname');?></div>
<div class="c_b_ad"><?php echo $this->session->userdata('customer_delivery_address');?></div>
<div class="c_b_ci"><?php echo $this->session->userdata('customer_delivery_city');?></div>
<div class="c_b_zip"><?php echo $this->session->userdata('customer_delivery_zip');?></div>
<div class="c_v_co">
<?php  if($this->session->userdata('customer_delivery_country')==1){ echo"France";} ?> 
<?php  if($this->session->userdata('customer_delivery_country')==3){ echo "Belgique";} ?>  
								
</div>
<div class="c_b_phone"><?php echo $this->session->userdata('customer_delivery_phone');?></div>

												       </div>
													
						  </div> </div>
                                <div class="form-card">
                                    <h2 class="fs-title ">2.Choix du mode de paiement</h2> <br><br>
                                        ...
                                        <div class="cart-detailed-totals">
                                          ...
                                          <div >  <span class="cart-products-count"> <?php echo count($this->cart->contents()); ?> article(s)</span> </div>
										     ...
										     <div   class="cart-summary-line cart-subtotal-shipping-ht">
                                                ...
                                                <span class="value shipping_price_ttc">€ <?php echo  number_format($totalshopingPrices*(1-$taxe), 2, ',', '') ;?></span>
                                                <div>
											  ...
											  <div   class="cart-summary-line cart-subtotal-shipping-ht">
                                                ...
                                                <span class="value total_ht totalCartsHT">€ <?php echo  number_format(($totalCart+$totalshopingPrices+$totalOptionPrice)*(1-$taxe), 2, ',', '') ;?></span>
                                                <div>
                                                    <small class="value"></small>
                                                </div>
                                            </div>
