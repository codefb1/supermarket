                ...
                <div class="row">
                    <div id="content-wrapper" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 onecol">
						...
						<div class=" check-cart">
						  <h1 class="title-page" style="text-align: center!important;"> <span>Assalamou Alaikom Wa Rahmet Allah ! Bismallah ça prendre que 3mn</span></h1>
						  </div> 
                    ...
                    <div class="col-md-12 mx-0">
                        <div id="msform">
                            ...
                            <ul id="progressbar">
                                ...
                                <li  class="active" id="account" style="margin-top: 20px;"><strong style="position: absolute;top: -22%;left: 48%;">1</strong> <strong>Mon compte</strong></li>
                                <li id="adresse" <?php if(($this->session->userdata('logged_in'))) { ?>  class="active"  <?php }  ?> style="margin-top: 20px;"><strong style="position: absolute;top: -22%;left: 48%;">2</strong><strong>Adresse de livraison</strong></li>
                               
								<li id="delivery" style="margin-top: 20px;"><strong style="position: absolute;top: -22%;left: 48%;">3</strong><strong>Livraison</strong></li>
                             
							   <li id="payment" style="margin-top: 20px;"><strong style="position: absolute;top: -22%;left: 48%;">4</strong><strong>Paiement</strong></li>
                            </ul> <!-- fieldsets -->
                             <fieldset <?php if(($this->session->userdata('logged_in'))) { ?>  style="display:none"  <?php }  ?>>
								...
								<div  class="col-sm-6">
								   ...
								   <input type="hidden" name="submitLogin" value="2">
									<input type="submit" name="next" class="valide_compte action-button new_acount" value="Valider" />
								   </form>
								   <form id="login-form" action="<?php echo base_url().'checkout';?>" method="post" class="customer-form">
					   ...
					   <div class="form-group identifie"  style="display:none;">
								...
								<div  class="col-sm-6">
									<input type="password" name="customer_password" required placeholder="Mot de passe" />
								 	...
								 	<input style="display:none;" type="submit" name="next" class="valide_compte action-button identifie" value="Valider" />
								   </form>
								     <?php }  ?>
								 </div>
								 ...
								 <div class="cart-summary carts-summary">
                                        <div class="cart-detailed-totals">
                                          ...
                                          <div >  <span class="cart-products-count"> <?php echo count($this->cart->contents()); ?> article(s)</span> </div>
										   ...
										   <div   class="cart-summary-line cart-subtotal-shipping-ttc" style="display:none;" id="cart-subtotal-shipping-ttc">
                                                <span class="label">
							  ...
							  <div class="form-card">
								...
								<div  class="col-sm-6">
									...
									<div  class="col-sm-6">
										...
										<div class="form-group ">
												<div  class="row">
									<label class="labels col-sm-3">Pays <span class="required">*</span></label>
									<div  class="col-sm-6">
									...
									<div  class="col-sm-6">
										...
										<div  class="row">
											...
											<div class="form-group ">
												...
												<label class="info_shopping" style="font-size: 18px!important;color: #000;">Utiliser cet adresse pour la facturation </label>
											  </div>
									...
									<input class="form-control" id="customer_billing_firstname"  name="customer_billing_firstname" type="text" placeholder="Nom" value="<?php echo $this->session->userdata('customer_firstname'); ?>">
									...
									<div class="form-group shopping"style="display:none">
										<div  class="row">
												<label class="labels col-sm-3">Prénom <span class="required">*</span></label>
											<div  class="col-sm-6">
									<input class="form-control"  id="customer_billing_lastname"  name="customer_billing_lastname" type="text" placeholder="Prénom" value="<?php echo $this->session->userdata('customer_lastname'); ?>">
									...
									<div class="form-group shopping"style="display:none">
										<div  class="row">
												<label class="labels col-sm-3">Adresse <span class="required">*</span></label>
											<div  class="col-sm-6">
									<input class="form-control"required id="customer_billing_address"  name="customer_billing_address" type="text" placeholder="Adresse" value="<?php echo $this->session->userdata('customer_address');?>">
                                    ...
                                    <?php }  ?>
								     	...
								     	<input style="float: left;margin-left: 6%;" type="button" name="next" class="setep_2 action-button" value="Suivant" />
                          		<input type="hidden" name="next" class="next action-button block_delivery" value="Suivant" />
                            ...
                            <fieldset>
							 <div class="cart-grid-right col-xs-12 col-lg-12">
                                ...
                                <div class="form-card">
                                                ...
                                                <tr id="wishlist_1" class="livreur">
                                                    <td>
                                                        <a style="font-size: 13px;"href="javascript:;">
																	...
																	<img style="width: 80%;" alt="<?php echo $transporter->transporter_name;?>"  src="<?php echo base_url().'admines/medias/transporters/'.$transporter->transporter_picture; ?>" class="img-responsive">
                                  ...
                                  <?php echo $transporter->transporter_short_text;?>
								...
								<input type="button" style="float: left;" name="next" class="next action-button" value="Suivant" />
                            </fieldset>
                            <fieldset>
							 <div class="row">
							 <div class="cart-grid-right col-xs-12 col-lg-9">
								<?php $totalCart=0; foreach ($this->cart->contents() as $items):
                      		 ...
                      		 <div class="cart-grid-right col-xs-12 col-lg-3">
							 		<h2 style="padding-top: 15px;font-size: 17px!important;text-align: center!important;">Adresse de livraison </h2>
									<div style="text-align: left;padding: 10px;"><b>Nom et Prénom : </b> <span class="client_info"> </div>
									<div style="text-align: left;padding: 10px;"><b>Adresse : </b> <span class="client_address"> </div>
								   <div style="text-align: left;padding: 10px;"><b>Pays : </b><span class="client_country"> </div>
								   <div style="text-align: left;padding: 10px;"><b>Téléphone :  </b><span class="client_phone"> </div>
							 </div>
							  </div>
                                <div class="form-card">
                                    <h2 class="fs-title ">Mode de paiements disponibles</h2> <br><br>
                                     <table class="std table">
								    ...
								    <tr id="wishlist_1">
										...
										<input style="float: left;margin-left: 6%;width: auto;" type="submit" name="make_payment" class=" action-button" value="Payer ma commande" />
