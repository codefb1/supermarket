...
<body id="<?php echo $body;?>">
    <header>
        ...
        <a href="<?php echo base_url();?>"  title="Go-Ferme-halal"> 
                        <img class="logo-mobile img-fluid" src="<?php echo base_url().'template/';?>logo/logo_mobile.jpg" alt="Go-Ferme-halal">
                    </a>
                </div>
            ...
            <div class="container container_pc">
			 <div class="row">
			   <div class="col-sm-3 col-md-3  col-lg-3 d-flex align-items-center paiement_header" >
					 ...
					 <div class="main-menu col-sm-5 col-md-5 col-lg-5 align-items-center justify-content-center navbar-expand-md " >

                    </div>
					     <div id="user_compte" class="col-sm-4 col-md-4  col-lg-4 align-items-center justify-content-end d-flex">
     ...
     <a href="<?php echo base_url().'accounts';?>"  class="acount acount_header">
      ...
      <?php } ?>
                          ...
                          <div class="desktop_cart">
                            <div class="blockcart block-cart cart-preview tiva-toggle">
                                <div class="header-cart tiva-toggle-btn">
                                  <a href="<?php echo base_url().'cart';?>"  title="Mon panier" class="carte_header" style="color: #d64652!important;">  Mon panier
				...
				<?php $this->load->view('views_menus/blockInfo.php');?> </div>-->
                  ...
                  <div class="main-menu col-sm-12 col-md-12 col-lg-12 align-items-center justify-content-center navbar-expand-md " style="text-align: center;margin-bottom: 20px;">
						 ...
						 <img  src="<?php echo base_url().'template/';?>logo/logo.jpg" alt="Go-Ferme-halal" title="Go-Ferme-halal"></a>
...
<!-- end block Info -->
    ...
    <div class="main-content" >
     <?php $this->load->view('views_menus/clear_session_search.php');?>
<?php echo $contents;?>
        <!-- main -->
